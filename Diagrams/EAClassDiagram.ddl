CREATE TABLE PaymentMethod (ID int(10) NOT NULL AUTO_INCREMENT, CurrentAmount decimal(19, 0), CardNumber bigint(19), SecurityCode varchar(255), ExpirationDate date, CardType varchar(255), Balance decimal(19, 0), NumRecharges int(10), LimigAmount decimal(19, 0), `Column` decimal(19, 0), Discriminator varchar(255) NOT NULL, PRIMARY KEY (ID));
...
CREATE TABLE Competition (ID int(10) NOT NULL AUTO_INCREMENT, SportID int(10) NOT NULL, ModalityID int(10) NOT NULL, Name varchar(255), Location varchar(255), StartDate date, EndDate date, Description varchar(255), Active tinyint(1), PRIMARY KEY (ID));
...
CREATE TABLE Subscription (ID int(10) NOT NULL AUTO_INCREMENT, NotificationTrackerID int(10) NOT NULL, InvoiceID int(10) NOT NULL, UserID int(10) NOT NULL, `Date` date, Paid tinyint(1), PRIMARY KEY (ID));
CREATE TABLE Match_event (ID int(10) NOT NULL AUTO_INCREMENT, CompetitionID int(10) NOT NULL, Description varchar(255), StartTime date, EndTime date, Location varchar(255), Active tinyint(1), PRIMARY KEY (ID));
CREATE TABLE Invoice (ID int(10) NOT NULL AUTO_INCREMENT, PaymentMethodID2 int(10) NOT NULL, PaymentMethodID int(10) NOT NULL, `Date` date, Amount decimal(19, 0), PRIMARY KEY (ID));
CREATE TABLE Event (ID int(10) NOT NULL AUTO_INCREMENT, Match_eventID int(10) NOT NULL, EventCategoryID int(10) NOT NULL, TextFormat varchar(255), ImageFormat varchar(255), VideoFormat varchar(255), PRIMARY KEY (ID));
...
CREATE TABLE Match_event_Athlete (Match_eventID int(10) NOT NULL, AthleteID int(10) NOT NULL, PRIMARY KEY (Match_eventID, AthleteID));
...
ALTER TABLE Match_event ADD CONSTRAINT FKMatch_even709417 FOREIGN KEY (CompetitionID) REFERENCES Competition (ID);
...
ALTER TABLE Subscription ADD CONSTRAINT FKSubscripti935920 FOREIGN KEY (InvoiceID) REFERENCES Invoice (ID);
ALTER TABLE Event ADD CONSTRAINT FKEvent908972 FOREIGN KEY (Match_eventID) REFERENCES Match_event (ID);
ALTER TABLE Match_event_Athlete ADD CONSTRAINT FKMatch_even519487 FOREIGN KEY (Match_eventID) REFERENCES Match_event (ID);
ALTER TABLE Match_event_Athlete ADD CONSTRAINT FKMatch_even731240 FOREIGN KEY (AthleteID) REFERENCES Athlete (ID);
...
ALTER TABLE Subscription ADD CONSTRAINT FKSubscripti299525 FOREIGN KEY (NotificationTrackerID) REFERENCES NotificationTracker (ID);
