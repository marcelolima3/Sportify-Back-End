...
CREATE TABLE EventCategory (ID int(10) NOT NULL AUTO_INCREMENT, SubscriptionID int(10) NOT NULL, Name varchar(255), Price decimal(19, 0), PRIMARY KEY (ID));
...
CREATE TABLE Subscription (ID int(10) NOT NULL AUTO_INCREMENT, InvoiceID int(10) NOT NULL, UserID int(10) NOT NULL, `Date` date, Paid tinyint(1), PRIMARY KEY (ID));
