...
CREATE TABLE Event (ID int(10) NOT NULL AUTO_INCREMENT, MatchID int(10) NOT NULL, EventCategoryID int(10) NOT NULL, TextFormat varchar(255), ImageFormat varchar(255), VideoFormat varchar(255), PRIMARY KEY (ID));
