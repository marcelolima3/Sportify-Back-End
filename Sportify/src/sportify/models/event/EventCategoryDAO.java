...
public class EventCategoryDAO {
	...
	public static EventCategory loadEventCategoryByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (EventCategory) session.load(EventCategory.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static EventCategory getEventCategoryByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (EventCategory) session.get(EventCategory.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static EventCategory loadEventCategoryByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (EventCategory) session.load(EventCategory.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static EventCategory getEventCategoryByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (EventCategory) session.get(EventCategory.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryEventCategory(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From EventCategory as EventCategory");
		if (condition != null)
	...
	public static boolean save(EventCategory eventCategory) throws PersistentException {
		try {
	...
	public static boolean delete(EventCategory eventCategory) throws PersistentException {
		try {
	...
	public static boolean refresh(EventCategory eventCategory) throws PersistentException {
		try {
	...
	public static boolean evict(EventCategory eventCategory) throws PersistentException {
		try {
