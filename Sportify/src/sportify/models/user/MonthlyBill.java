...
public class MonthlyBill extends PaymentMethod {
	...
	public final InvoiceSetCollection payments = new InvoiceSetCollection(this, _ormAdapter, ORMConstants.KEY_MONTHLYBILL_PAYMENTS, ORMConstants.KEY_MUL_ONE_TO_MANY);
