...
import sportify.models.event.EventCriteria;
...
public class NotificationTrackerCriteria extends AbstractORMCriteria {
	...
	public EventCriteria createNotificationHistoryCriteria() {
		return new EventCriteria(createCriteria("ORM_NotificationHistory"));
	}
