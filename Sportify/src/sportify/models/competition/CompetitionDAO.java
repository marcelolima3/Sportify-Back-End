...
public class CompetitionDAO {
	...
	public static boolean save(Competition competition) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().saveObject(competition);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Competition competition) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().deleteObject(competition);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Competition competition) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().getSession().refresh(competition);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Competition competition) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().getSession().evict(competition);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
