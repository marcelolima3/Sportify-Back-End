...
import sportify.models.TeamSetCollection;
import sportify.models.event.EventCategorySetCollection;
...
public class Modality {
	...
	private java.util.Set this_getSet (int key) {
		if (key == ORMConstants.KEY_MODALITY_EVENTS) {
			return ORM_events;
		}
	...
	public final EventCategorySetCollection events = new EventCategorySetCollection(this, _ormAdapter, ORMConstants.KEY_MODALITY_EVENTS, ORMConstants.KEY_MUL_ONE_TO_MANY);
	...
	public final CompetitionSetCollection competitions = new CompetitionSetCollection(this, _ormAdapter, ORMConstants.KEY_MODALITY_COMPETITIONS, ORMConstants.KEY_MUL_ONE_TO_MANY);
	...
	public final TeamSetCollection teams = new TeamSetCollection(this, _ormAdapter, ORMConstants.KEY_MODALITY_TEAMS, ORMConstants.KEY_MUL_ONE_TO_MANY);
