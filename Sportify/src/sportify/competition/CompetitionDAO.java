...
public class CompetitionDAO {
	...
	public static Competition loadCompetitionByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Competition) session.load(sportify.competition.Competition.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Competition getCompetitionByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Competition) session.get(sportify.competition.Competition.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Competition loadCompetitionByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Competition) session.load(sportify.competition.Competition.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Competition getCompetitionByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Competition) session.get(sportify.competition.Competition.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryCompetition(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From sportify.competition.Competition as Competition");
		if (condition != null)
	...
	public static Competition createCompetition() {
		return new sportify.competition.Competition();
	}
	
	public static boolean save(sportify.competition.Competition competition1) throws PersistentException {
		try {
	...
	public static boolean delete(sportify.competition.Competition competition1) throws PersistentException {
		try {
	...
	public static boolean refresh(sportify.competition.Competition competition1) throws PersistentException {
		try {
	...
	public static boolean evict(sportify.competition.Competition competition1) throws PersistentException {
		try {
