...
public class SportDAO {
	...
	public static Sport loadSportByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Sport) session.load(sportify.competition.Sport.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Sport getSportByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Sport) session.get(sportify.competition.Sport.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Sport loadSportByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Sport) session.load(sportify.competition.Sport.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Sport getSportByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Sport) session.get(sportify.competition.Sport.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List querySport(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From sportify.competition.Sport as Sport");
		if (condition != null)
	...
	public static Sport createSport() {
		return new sportify.competition.Sport();
	}
	
	public static boolean save(sportify.competition.Sport sport) throws PersistentException {
		try {
	...
	public static boolean delete(sportify.competition.Sport sport) throws PersistentException {
		try {
	...
	public static boolean refresh(sportify.competition.Sport sport) throws PersistentException {
		try {
	...
	public static boolean evict(sportify.competition.Sport sport) throws PersistentException {
		try {
