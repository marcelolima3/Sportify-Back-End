...
public class ModalityDAO {
	...
	public static Modality loadModalityByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Modality) session.load(sportify.competition.Modality.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Modality getModalityByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Modality) session.get(sportify.competition.Modality.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Modality loadModalityByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Modality) session.load(sportify.competition.Modality.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Modality getModalityByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Modality) session.get(sportify.competition.Modality.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryModality(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From sportify.competition.Modality as Modality");
		if (condition != null)
	...
	public static Modality createModality() {
		return new sportify.competition.Modality();
	}
	
	public static boolean save(sportify.competition.Modality modality) throws PersistentException {
		try {
	...
	public static boolean delete(sportify.competition.Modality modality) throws PersistentException {
		try {
	...
	public static boolean refresh(sportify.competition.Modality modality) throws PersistentException {
		try {
	...
	public static boolean evict(sportify.competition.Modality modality) throws PersistentException {
		try {
