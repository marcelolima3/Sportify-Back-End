...
public class TeamDAO {
	...
	public static Team loadTeamByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Team) session.load(sportify.subentities.Team.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Team getTeamByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Team) session.get(sportify.subentities.Team.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Team loadTeamByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Team) session.load(sportify.subentities.Team.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Team getTeamByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Team) session.get(sportify.subentities.Team.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryTeam(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From sportify.subentities.Team as Team");
		if (condition != null)
	...
	public static Team createTeam() {
		return new sportify.subentities.Team();
	}
	
	public static boolean save(sportify.subentities.Team team) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().saveObject(team);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(sportify.subentities.Team team) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().deleteObject(team);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(sportify.subentities.Team team)throws PersistentException {
		try {
			sportify.subentities.Athlete[] lAthletess = team.athletes.toArray();
	...
	public static boolean deleteAndDissociate(sportify.subentities.Team team, org.orm.PersistentSession session)throws PersistentException {
		try {
			sportify.subentities.Athlete[] lAthletess = team.athletes.toArray();
			for(int i = 0; i < lAthletess.length; i++) {
				lAthletess[i].setTeam(null);
	...
	public static boolean refresh(sportify.subentities.Team team) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().getSession().refresh(team);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(sportify.subentities.Team team) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().getSession().evict(team);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
