...
public class InvoicePaymentDAO {
	...
	public static InvoicePayment loadInvoicePaymentByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (InvoicePayment) session.load(sportify.user.InvoicePayment.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static InvoicePayment getInvoicePaymentByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (InvoicePayment) session.get(sportify.user.InvoicePayment.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static InvoicePayment loadInvoicePaymentByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (InvoicePayment) session.load(sportify.user.InvoicePayment.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static InvoicePayment getInvoicePaymentByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (InvoicePayment) session.get(sportify.user.InvoicePayment.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryInvoicePayment(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From sportify.user.InvoicePayment as InvoicePayment");
		if (condition != null)
	...
	public static InvoicePayment createInvoicePayment() {
		return new sportify.user.InvoicePayment();
	}
	
	public static boolean save(sportify.user.InvoicePayment invoicePayment) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().saveObject(invoicePayment);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(sportify.user.InvoicePayment invoicePayment) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().deleteObject(invoicePayment);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(sportify.user.InvoicePayment invoicePayment) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().getSession().refresh(invoicePayment);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(sportify.user.InvoicePayment invoicePayment) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().getSession().evict(invoicePayment);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
