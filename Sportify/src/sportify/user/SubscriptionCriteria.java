...
public class SubscriptionCriteria extends AbstractORMCriteria {
	...
	public sportify.event.EventCategoryCriteria createSubscribedEventsCriteria() {
		return new sportify.event.EventCategoryCriteria(createCriteria("ORM_SubscribedEvents"));
	}
