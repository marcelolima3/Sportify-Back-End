...
public class PaymentMethodDAO {
	...
	public static PaymentMethod loadPaymentMethodByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (PaymentMethod) session.load(sportify.user.PaymentMethod.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static PaymentMethod getPaymentMethodByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (PaymentMethod) session.get(sportify.user.PaymentMethod.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static PaymentMethod loadPaymentMethodByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (PaymentMethod) session.load(sportify.user.PaymentMethod.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static PaymentMethod getPaymentMethodByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (PaymentMethod) session.get(sportify.user.PaymentMethod.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryPaymentMethod(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From sportify.user.PaymentMethod as PaymentMethod");
		if (condition != null)
	...
	public static boolean save(sportify.user.PaymentMethod paymentMethod) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().saveObject(paymentMethod);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(sportify.user.PaymentMethod paymentMethod) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().deleteObject(paymentMethod);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(sportify.user.PaymentMethod paymentMethod) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().getSession().refresh(paymentMethod);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(sportify.user.PaymentMethod paymentMethod) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().getSession().evict(paymentMethod);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
