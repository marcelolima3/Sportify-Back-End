...
public class MonthlyBill extends sportify.user.PaymentMethod {
	public MonthlyBill() {
	}
	
	private java.util.Set this_getSet (int key) {
		if (key == sportify.competition.ORMConstants.KEY_MONTHLYBILL_PAYMENTS) {
			return ORM_payments;
		}
	...
	public final sportify.user.InvoiceSetCollection payments = new sportify.user.InvoiceSetCollection(this, _ormAdapter, sportify.competition.ORMConstants.KEY_MONTHLYBILL_PAYMENTS, sportify.competition.ORMConstants.KEY_MUL_ONE_TO_MANY);
