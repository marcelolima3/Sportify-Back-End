...
public class NotificationTrackerDAO {
	...
	public static NotificationTracker loadNotificationTrackerByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (NotificationTracker) session.load(sportify.user.NotificationTracker.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static NotificationTracker getNotificationTrackerByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (NotificationTracker) session.get(sportify.user.NotificationTracker.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static NotificationTracker loadNotificationTrackerByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (NotificationTracker) session.load(sportify.user.NotificationTracker.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static NotificationTracker getNotificationTrackerByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (NotificationTracker) session.get(sportify.user.NotificationTracker.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryNotificationTracker(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From sportify.user.NotificationTracker as NotificationTracker");
		if (condition != null)
	...
	public static NotificationTracker createNotificationTracker() {
		return new sportify.user.NotificationTracker();
	}
	
	public static boolean save(sportify.user.NotificationTracker notificationTracker) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().saveObject(notificationTracker);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(sportify.user.NotificationTracker notificationTracker) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().deleteObject(notificationTracker);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(sportify.user.NotificationTracker notificationTracker) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().getSession().refresh(notificationTracker);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(sportify.user.NotificationTracker notificationTracker) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().getSession().evict(notificationTracker);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
