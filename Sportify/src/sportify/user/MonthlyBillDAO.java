...
public class MonthlyBillDAO {
	...
	public static MonthlyBill loadMonthlyBillByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (MonthlyBill) session.load(sportify.user.MonthlyBill.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static MonthlyBill getMonthlyBillByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (MonthlyBill) session.get(sportify.user.MonthlyBill.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static MonthlyBill loadMonthlyBillByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (MonthlyBill) session.load(sportify.user.MonthlyBill.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static MonthlyBill getMonthlyBillByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (MonthlyBill) session.get(sportify.user.MonthlyBill.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryMonthlyBill(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From sportify.user.MonthlyBill as MonthlyBill");
		if (condition != null)
	...
	public static MonthlyBill createMonthlyBill() {
		return new sportify.user.MonthlyBill();
	}
	
	public static boolean save(sportify.user.MonthlyBill monthlyBill) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().saveObject(monthlyBill);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(sportify.user.MonthlyBill monthlyBill) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().deleteObject(monthlyBill);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(sportify.user.MonthlyBill monthlyBill) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().getSession().refresh(monthlyBill);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(sportify.user.MonthlyBill monthlyBill) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().getSession().evict(monthlyBill);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
