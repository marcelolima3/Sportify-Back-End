...
public class EventCategoryDAO {
	...
	public static EventCategory loadEventCategoryByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (EventCategory) session.load(sportify.event.EventCategory.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static EventCategory getEventCategoryByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (EventCategory) session.get(sportify.event.EventCategory.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static EventCategory loadEventCategoryByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (EventCategory) session.load(sportify.event.EventCategory.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static EventCategory getEventCategoryByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (EventCategory) session.get(sportify.event.EventCategory.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryEventCategory(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From sportify.event.EventCategory as EventCategory");
		if (condition != null)
	...
	public static EventCategory createEventCategory() {
		return new sportify.event.EventCategory();
	}
	
	public static boolean save(sportify.event.EventCategory eventCategory) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().saveObject(eventCategory);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(sportify.event.EventCategory eventCategory) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().deleteObject(eventCategory);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(sportify.event.EventCategory eventCategory) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().getSession().refresh(eventCategory);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(sportify.event.EventCategory eventCategory) throws PersistentException {
		try {
			sportify.competition.EAClassDiagramPersistentManager.instance().getSession().evict(eventCategory);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
