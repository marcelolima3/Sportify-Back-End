...
public class MonthlyBillDAO {
	...
	public static MonthlyBill loadMonthlyBillByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (MonthlyBill) session.load(com.Sportify.Entities.payment.MonthlyBill.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static MonthlyBill getMonthlyBillByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (MonthlyBill) session.get(com.Sportify.Entities.payment.MonthlyBill.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static MonthlyBill loadMonthlyBillByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (MonthlyBill) session.load(com.Sportify.Entities.payment.MonthlyBill.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static MonthlyBill getMonthlyBillByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (MonthlyBill) session.get(com.Sportify.Entities.payment.MonthlyBill.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryMonthlyBill(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From com.Sportify.Entities.payment.MonthlyBill as MonthlyBill");
		if (condition != null)
	...
	public static MonthlyBill createMonthlyBill() {
		return new com.Sportify.Entities.payment.MonthlyBill();
	}
	
	public static boolean save(com.Sportify.Entities.payment.MonthlyBill monthlyBill) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().saveObject(monthlyBill);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(com.Sportify.Entities.payment.MonthlyBill monthlyBill) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().deleteObject(monthlyBill);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(com.Sportify.Entities.payment.MonthlyBill monthlyBill) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().getSession().refresh(monthlyBill);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(com.Sportify.Entities.payment.MonthlyBill monthlyBill) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().getSession().evict(monthlyBill);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
