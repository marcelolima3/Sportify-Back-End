...
public class SportDAO {
	...
	public static Sport loadSportByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Sport) session.load(com.Sportify.Entities.competition.Sport.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Sport getSportByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Sport) session.get(com.Sportify.Entities.competition.Sport.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Sport loadSportByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Sport) session.load(com.Sportify.Entities.competition.Sport.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Sport getSportByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Sport) session.get(com.Sportify.Entities.competition.Sport.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List querySport(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From com.Sportify.Entities.competition.Sport as Sport");
		if (condition != null)
	...
	public static Sport createSport() {
		return new com.Sportify.Entities.competition.Sport();
	}
	
	public static boolean save(com.Sportify.Entities.competition.Sport sport) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().saveObject(sport);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(com.Sportify.Entities.competition.Sport sport) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().deleteObject(sport);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(com.Sportify.Entities.competition.Sport sport) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().getSession().refresh(sport);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(com.Sportify.Entities.competition.Sport sport) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().getSession().evict(sport);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
