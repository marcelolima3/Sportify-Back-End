...
public class EventCategoryDAO {
	...
	public static EventCategory loadEventCategoryByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (EventCategory) session.load(com.Sportify.Entities.event.EventCategory.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static EventCategory getEventCategoryByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (EventCategory) session.get(com.Sportify.Entities.event.EventCategory.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static EventCategory loadEventCategoryByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (EventCategory) session.load(com.Sportify.Entities.event.EventCategory.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static EventCategory getEventCategoryByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (EventCategory) session.get(com.Sportify.Entities.event.EventCategory.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryEventCategory(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From com.Sportify.Entities.event.EventCategory as EventCategory");
		if (condition != null)
	...
	public static EventCategory createEventCategory() {
		return new com.Sportify.Entities.event.EventCategory();
	}
	
	public static boolean save(com.Sportify.Entities.event.EventCategory eventCategory) throws PersistentException {
		try {
	...
	public static boolean delete(com.Sportify.Entities.event.EventCategory eventCategory) throws PersistentException {
		try {
	...
	public static boolean refresh(com.Sportify.Entities.event.EventCategory eventCategory) throws PersistentException {
		try {
	...
	public static boolean evict(com.Sportify.Entities.event.EventCategory eventCategory) throws PersistentException {
		try {
