...
public class UserDAO {
	...
	public static User loadUserByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (User) session.load(com.Sportify.Entities.user.User.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User getUserByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (User) session.get(com.Sportify.Entities.user.User.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User loadUserByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (User) session.load(com.Sportify.Entities.user.User.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User getUserByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (User) session.get(com.Sportify.Entities.user.User.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryUser(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From com.Sportify.Entities.user.User as User");
		if (condition != null)
	...
	public static User createUser() {
		return new com.Sportify.Entities.user.User();
	}
	
	public static boolean save(com.Sportify.Entities.user.User user1) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().saveObject(user1);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(com.Sportify.Entities.user.User user1) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().deleteObject(user1);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(com.Sportify.Entities.user.User user1) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().getSession().refresh(user1);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(com.Sportify.Entities.user.User user1) throws PersistentException {
		try {
			EAClassDiagramPersistentManager.instance().getSession().evict(user1);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
