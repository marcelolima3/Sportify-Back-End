...
public class SubscriptionDAO {
	...
	public static boolean save(Subscription subscription) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().saveObject(subscription);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Subscription subscription) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().deleteObject(subscription);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Subscription subscription) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().getSession().refresh(subscription);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Subscription subscription) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().getSession().evict(subscription);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
