...
public class TeamDAO {
	...
	public static List queryTeam(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Team as Team");
		if (condition != null)
	...
	public static boolean save(Team team) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().saveObject(team);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Team team) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().deleteObject(team);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Team team) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().getSession().refresh(team);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Team team) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().getSession().evict(team);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
