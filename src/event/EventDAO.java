...
public class EventDAO {
	...
	public static Event loadEventByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Event) session.load(event.Event.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Event getEventByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Event) session.get(event.Event.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Event loadEventByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Event) session.load(event.Event.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Event getEventByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Event) session.get(event.Event.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryEvent(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From event.Event as Event");
		if (condition != null)
	...
	public static boolean save(event.Event event1) throws PersistentException {
		try {
	...
	public static boolean delete(event.Event event1) throws PersistentException {
		try {
	...
	public static boolean refresh(event.Event event1) throws PersistentException {
		try {
	...
	public static boolean evict(event.Event event1) throws PersistentException {
		try {
