...
public class AthleteDAO {
	...
	public static Athlete loadAthleteByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Athlete) session.load(Athlete.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Athlete getAthleteByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Athlete) session.get(Athlete.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Athlete loadAthleteByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Athlete) session.load(Athlete.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Athlete getAthleteByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Athlete) session.get(Athlete.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryAthlete(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Athlete as Athlete");
		if (condition != null)
	...
	public static boolean save(Athlete athlete) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().saveObject(athlete);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Athlete athlete) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().deleteObject(athlete);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(Athlete athlete)throws PersistentException {
		try {
			if (athlete.getTeam() != null) {
				athlete.getTeam().athletes.remove(athlete);
			}
			
			Match[] lMatchess = athlete.matches.toArray();
	...
	public static boolean deleteAndDissociate(Athlete athlete, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (athlete.getTeam() != null) {
				athlete.getTeam().athletes.remove(athlete);
			}
	...
	public static boolean refresh(Athlete athlete) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().getSession().refresh(athlete);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Athlete athlete) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().getSession().evict(athlete);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
