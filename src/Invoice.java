...
public class Invoice {
	...
	private java.util.Set this_getSet (int key) {
		if (key == event.ORMConstants.KEY_INVOICE_SUBSCRIPTIONS) {
	...
	public final SubscriptionSetCollection subscriptions = new SubscriptionSetCollection(this, _ormAdapter, event.ORMConstants.KEY_INVOICE_SUBSCRIPTIONS, event.ORMConstants.KEY_MUL_ONE_TO_MANY);
