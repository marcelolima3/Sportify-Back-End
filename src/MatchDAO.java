...
public class MatchDAO {
	...
	public static Match loadMatchByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Match) session.load(Match.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Match getMatchByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Match) session.get(Match.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Match loadMatchByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Match) session.load(Match.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Match getMatchByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Match) session.get(Match.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryMatch(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Match as Match");
		if (condition != null)
	...
	public static boolean save(Match match) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().saveObject(match);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Match match) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().deleteObject(match);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(Match match)throws PersistentException {
		try {
			Athlete[] lAthletess = match.athletes.toArray();
	...
	public static boolean deleteAndDissociate(Match match, org.orm.PersistentSession session)throws PersistentException {
		try {
			Athlete[] lAthletess = match.athletes.toArray();
			for(int i = 0; i < lAthletess.length; i++) {
				lAthletess[i].matches.remove(match);
	...
	public static boolean refresh(Match match) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().getSession().refresh(match);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Match match) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().getSession().evict(match);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
