...
public class ModalityDAO {
	...
	public static Modality loadModalityByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Modality) session.load(Modality.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Modality getModalityByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Modality) session.get(Modality.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Modality loadModalityByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Modality) session.load(Modality.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Modality getModalityByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Modality) session.get(Modality.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryModality(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Modality as Modality");
		if (condition != null)
	...
	public static boolean save(Modality modality) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().saveObject(modality);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Modality modality) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().deleteObject(modality);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Modality modality) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().getSession().refresh(modality);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Modality modality) throws PersistentException {
		try {
			event.EAClassDiagramPersistentManager.instance().getSession().evict(modality);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
