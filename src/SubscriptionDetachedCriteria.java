...
public class SubscriptionDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public event.EventCategoryDetachedCriteria createSubscribedEventsCriteria() {
		return new event.EventCategoryDetachedCriteria(createCriteria("ORM_SubscribedEvents"));
	}
