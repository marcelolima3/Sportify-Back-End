...
public class InvoicePayment extends PaymentMethod {
	...
	private java.util.Set this_getSet (int key) {
		if (key == event.ORMConstants.KEY_INVOICEPAYMENT_PAYMENTS) {
			return ORM_payments;
		}
	...
	public final InvoiceSetCollection payments = new InvoiceSetCollection(this, _ormAdapter, event.ORMConstants.KEY_INVOICEPAYMENT_PAYMENTS, event.ORMConstants.KEY_MUL_ONE_TO_MANY);
